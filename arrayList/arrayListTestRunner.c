...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_adds_the_data_at_the_last_of_arrayList");
	setup();
		test_adds_the_data_at_the_last_of_arrayList();
	tearDown();
	testEnded();
	testStarted("test_add_fails_when_list_is_null");
	setup();
		test_add_fails_when_list_is_null();
	tearDown();
	testEnded();
	testStarted("test_search_given_data_into_List_and_tells_the_index");
	setup();
		test_search_given_data_into_List_and_tells_the_index();
	tearDown();
	testEnded();
	testStarted("test_search_gives_minus_one_when_data_is_not_present");
	setup();
		test_search_gives_minus_one_when_data_is_not_present();
	tearDown();
	testEnded();
